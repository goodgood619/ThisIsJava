...
public class PerformanceExample {
    public static void main(String[] args) throws IOException {
        Path from = Paths.get("C:\\Users\\user\\Pictures\\캡처복사테스트.PNG");
        Path to1 = Paths.get("C:\\Users\\user\\Pictures\\캡처.PNG");
        Path to2 = Paths.get("C:\\Users\\user\\Pictures\\JPA성능향상.PNG");
